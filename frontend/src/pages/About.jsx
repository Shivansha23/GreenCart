  ...
  return (
    <div className="bg-white transition-colors duration-200">
      ...
      <div className='flex flex-col md:flex-row text-sm mb-20'>
          <div className='border border-green-100 px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5 bg-[#f8f9f5]'>
      ...
      <div className='bg-[#f8f9f5] p-8 mb-12 rounded-lg'>
        <h3 className='text-xl font-semibold text-green-600 mb-4'>Our Eco-Friendly Promise</h3>
